...
$user=Auth::user();
$items=Database::query('SELECT * FROM notifications WHERE user_id=? ORDER BY created_at DESC',[$user['id']])->fetchAll();
page_header('การแจ้งเตือน','ข่าวสารเกี่ยวกับนัดหมายและการรักษา');?>
