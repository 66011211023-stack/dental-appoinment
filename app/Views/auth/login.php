    ...
    <section class="auth-panel">
        <div class="auth-card auth-screen" data-auth="login" <?=$screen==='login'?'':'hidden'?>>
            ...
            <div class="auth-heading">
                <span class="eyebrow">ยินดีต้อนรับ</span>
                <h2>เข้าสู่ระบบ</h2>
            ...
            <form method="post" action="/?page=login" class="form-stack" autocomplete="off">
                <label>อีเมล หรือชื่อผู้ใช้เจ้าหน้าที่
                    <input name="username" value="" required autocomplete="off" placeholder="example@gmail.com หรือ admin">
                </label>
                <label>รหัสผ่าน
                    <span class="password-input-wrap">
                        <input name="password" value="" required type="password" autocomplete="new-password" placeholder="กรอกรหัสผ่าน">
                        <button type="button" class="password-toggle" data-password-toggle aria-label="แสดงรหัสผ่าน" title="แสดงรหัสผ่าน"><?=$eyeIcon?></button>
                    </span>
                </label>
                <div class="form-row">
                    <span></span>
                    <button type="button" class="text-button auth-go" data-target="forgot">ลืมรหัสผ่าน?</button>
                </div>
        ...
        <div class="auth-card compact auth-screen" data-auth="new-password" <?=$screen==='new-password'?'':'hidden'?>>
            ...
            <div class="auth-heading">
                <span class="eyebrow">ขั้นตอนที่ 2 จาก 2</span>
            ...
            <form method="post" action="/?page=login" class="form-stack">
                ...
                <label>รหัสผ่านใหม่
                    <span class="password-input-wrap">
                        <input required minlength="4" name="password" type="password" autocomplete="new-password" placeholder="รหัสผ่านใหม่">
                        <button type="button" class="password-toggle" data-password-toggle aria-label="แสดงรหัสผ่าน" title="แสดงรหัสผ่าน"><?=$eyeIcon?></button>
                    </span>
                </label>
                <label>ยืนยันรหัสผ่าน
                    <span class="password-input-wrap">
                        <input required minlength="4" name="password_confirmation" type="password" autocomplete="new-password" placeholder="ยืนยันรหัสผ่านใหม่">
                        <button type="button" class="password-toggle" data-password-toggle aria-label="แสดงรหัสผ่าน" title="แสดงรหัสผ่าน"><?=$eyeIcon?></button>
                    </span>
                </label>
