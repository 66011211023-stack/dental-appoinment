-- สำหรับติดตั้งใหม่บน InfinityFree
-- คำเตือน: ไฟล์นี้ลบตารางและข้อมูลเดิมทั้งหมดก่อนสร้างใหม่
SET FOREIGN_KEY_CHECKS=0;
DROP TABLE IF EXISTS login_logs, notifications, treatment_rights,
dentist_schedules, material_transactions, materials, treatments,
medical_histories, appointments, dentists, patients, users;
